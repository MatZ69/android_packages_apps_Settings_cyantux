...
public class DeviceInfoSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        findPreference("build_number").setSummary("CyanTUX series");
        findPreference("kernel_version").setSummary("2.6.35.14-ukieTux kernel");
        findPreference("mod_version").setSummary("CyanTUX-Release");
        findPreference("mod_version").setEnabled(true);
        findPreference("build_date").setSummary("Anytime You want :P");
        findPreference("devid").setSummary("TuxKid's [T.K]");
	findPreference("thanks").setSummary("BNC,B10S,and Android Makassar-DEV");
